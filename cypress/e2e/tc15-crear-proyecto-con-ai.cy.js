describe('Crear proyecto desde cero', () => {
  ...
  it('debería crear un nuevo proyecto usando IA', () => {
...
Desarrollador: Podemos iniciar la próxima semana, prepararé el backlog inicial.`
    ...
    cy.contains('button', 'Generar con IA').click()

    // Esperar a que la IA genere el contenido (ajustar tiempo según sea necesario)
    cy.wait(5000)
    ...
    // Verificar que se creó el proyecto buscando el título en la tarjeta
    cy.get('.tracking-tight.text-lg.font-bold')
